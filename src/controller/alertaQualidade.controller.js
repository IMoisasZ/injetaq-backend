...
const createAlert = async (req, res, next) => {
	try {
		...
		logger.info(`POST - /alerta_qualidade/add - ${JSON.stringify(alert)}`)
	} catch (error) {
		next(error)
	}
}
...
const updateAlert = async (req, res, next) => {
	try {
		...
		logger.info(`PATCH - /alerta_qualidade/add - ${JSON.stringify(alert)}`)
	} catch (error) {
		next(error)
	}
}
...
const getAlerts = async (req, res, next) => {
	try {
		...
		logger.info(`GET - /alerta_qualidade/data - ALL ALERTS`)
	} catch (error) {
		next(error)
	}
}
...
const getAlert = async (req, res, next) => {
	try {
		...
		logger.info(`GET - /alerta_qualidade/data/:${req.params.id}`)
	} catch (error) {
		next(error)
	}
}
...
const changeStatusAlert = async (req, res, next) => {
	try {
		...
		logger.info(`PUT - /alerta_qualidade/update -${JSON.stringify}`)
	} catch (error) {
		next(error)
	}
}
